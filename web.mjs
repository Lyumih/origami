...
(function ($) {
    class $origami_app extends $mol_page {
        ...
        Route_text() {
            const obj = new this.$.$mol_text();
            obj.text = () => "Построение пешего и автомобильного маршрута (допустимо использование сторонних сервисов)";
            return obj;
        }
        Route() {
            const obj = new this.$.$mol_view();
        ...
        Bank_text() {
            const obj = new this.$.$mol_text();
            obj.text = () => "Поиск оптимального отделения с учетом загруженности отделения и задач клиента на основе разработанного алгоритма";
            return obj;
        }
        Bank() {
            const obj = new this.$.$mol_view();
    ...
    __decorate([
        $mol_mem
    ], $origami_app.prototype, "Route", null);
    __decorate([
        $mol_mem
    ], $origami_app.prototype, "Bank_text", null);
    __decorate([
        $mol_mem
    ], $origami_app.prototype, "Bank", null);
    __decorate([
        $mol_mem
    ], $origami_app.prototype, "Wow_text", null);
    __decorate([
        $mol_mem
    ...
    __decorate([
        $mol_mem
    ], $origami_app.prototype, "Office_icon", null);
    __decorate([
        $mol_mem
    ], $origami_app.prototype, "Office_link", null);
    __decorate([
        $mol_mem
...
;
var $node = $node || {} ; $node[ "/origami/app/logo.svg" ] = "data:image/svg+xml;base64,"
