...
(function ($) {
    class $origami_app extends $mol_book2_catalog {
        ...
        GitHub() {
            ...
            obj.uri = () => "https://github.com/Lyumih/origami";
            return obj;
        }
        Lights() {
    ...
    __decorate([
        $mol_mem
    ], $origami_app.prototype, "logout", null);
    __decorate([
        $mol_mem
    ], $origami_app.prototype, "Logout_icon", null);
    __decorate([
        $mol_mem
    ], $origami_app.prototype, "Logout", null);
    __decorate([
        $mol_mem
    ], $origami_app.prototype, "GitHub", null);
    __decorate([
        $mol_mem
    ], $origami_app.prototype, "Lights", null);
    __decorate([
        $mol_mem
    ], $origami_app.prototype, "Map_text", null);
    __decorate([
        $mol_mem
    ], $origami_app.prototype, "Place", null);
    __decorate([
        $mol_mem
    ], $origami_app.prototype, "Map_show", null);
    __decorate([
        $mol_mem
