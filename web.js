...
(function ($) {
    class $origami_app extends $mol_page {
        ...
        Luck() {
            const obj = new this.$.$mol_icon_horseshoe();
            return obj;
        }
    }
    __decorate([
        $mol_mem
    ], $origami_app.prototype, "Luck", null);
