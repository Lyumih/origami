...
(function ($) {
    class $origami_app_calc extends $mol_list {
        ...
        Amount_control() {
            const obj = new this.$.$origami_app_calc_number();
            obj.value = (next) => this.amount(next);
            obj.value_min = () => 1;
            obj.value_max = () => 100000000;
            return obj;
        }
        Amount_field() {
    ...
    __decorate([
        $mol_mem
    ], $origami_app_calc.prototype, "is_enabled", null);
    __decorate([
        $mol_mem
    ...
    class $origami_app_calc_number extends $mol_number {
        Inc() {
            return null;
        }
        Dec() {
    ...
    $.$origami_app_calc_number = $origami_app_calc_number;
})($ || ($ = {}));
...
(function ($) {
    class $origami_app extends $mol_page {
        ...
        Settings() {
            const obj = new this.$.$mol_link();
            obj.hint = () => "Журнал ВТБ";
            obj.uri = () => "https://t.me/vtb_more_tech_bot";
            obj.sub = () => [
                this.Settings_icon()
            ];
            return obj;
        ...
        Main() {
            const obj = new this.$.$origami_app_calc();
            return obj;
        }
        World() {
            const obj = new this.$.$origami_app_world();
    ...
    __decorate([
        $mol_mem
    ], $origami_app.prototype, "Settings_icon", null);
    __decorate([
        $mol_mem
    ], $origami_app.prototype, "Settings", null);
    __decorate([
        $mol_mem
    ], $origami_app.prototype, "Main", null);
    __decorate([
        $mol_mem
    ...
    __decorate([
        $mol_mem
    ], $origami_app.prototype, "Main_link", null);
    __decorate([
        $mol_mem
    ], $origami_app.prototype, "Bank_link", null);
    __decorate([
        $mol_mem
    ], $origami_app.prototype, "Atms_link", null);
    __decorate([
        $mol_mem
...
(function ($) {
    class $origami_app_bank extends $mol_list {
        ...
        Bank_time(id) {
            const obj = new this.$.$mol_text();
            obj.text = () => this.bank_time(id);
            return obj;
        }
        bank_workload(id, next) {
            if (next !== undefined)
                return next;
            return 0;
        }
        Bank_workload(id) {
            const obj = new this.$.$mol_text();
            obj.attr = () => ({
                workload: this.bank_workload(id)
            });
            obj.text = () => "Загруженность";
            return obj;
        }
        Bank_status_line(id) {
            const obj = new this.$.$mol_view();
    ...
    __decorate([
        $mol_mem_key
    ], $origami_app_bank.prototype, "Bank_time", null);
    __decorate([
        $mol_mem_key
...
var $;
(function ($) {
    $mol_style_attach("origami/app/atm/atm.view.css", "[origami_app_atms] {\n\tmargin-top: 0;\n}\n\n[origami_app_atms_atm_list] {\n\tgap: 0.75rem;\n}\n\n[origami_app_atm_atm] {\n\tflex-direction: column;\n\tborder-radius: 20px;\n\tbackground-color: white;\n}\n\n[origami_app_atm_atm_status_line] {\n\talign-items: center;\n\tpadding: var(--mol_gap_text);\n\tjustify-content: space-between;\n\tfont-size: 14px;\n}\n\n[origami_app_atm_atm_status_line]>[mol_icon] {\n\tcolor: var(--origami_app_primary_light);\n}\n\n[origami_app_atm_cashswitcher] {\n\tjustify-content: center;\n\tfont-size: 0.75rem;\n}\n\n[origami_app_atm_atm_distance],\n[origami_app_atm_atm_time] {\n\tmargin-left: 18px;\n\tposition: relative;\n}\n\n[origami_app_atm_atm_distance]::before,\n[origami_app_atm_atm_time]::before {\n\tcontent: '';\n\tposition: absolute;\n\tbottom: 11px;\n\tleft: -18px;\n\twidth: 24px;\n\theight: 24px;\n\tbackground-size: contain;\n}\n\n[origami_app_atm_atm_distance]::before {\n\tbackground-image: url(./origami/app/assets/img/traced.svg);\n}\n\n[origami_app_atm_atm_time]::before {\n\tbackground-image: url(./origami/app/assets/img/time.svg);\n}\n");
})($ || ($ = {}));
//origami/app/atm/-css/atm.view.css.ts
